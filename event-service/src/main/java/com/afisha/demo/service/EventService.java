...
public class EventService implements IEventService {
    ...
    @Override
    public Page<? extends Event> findAll(Type type, Pageable pageable) {
        return switch (type) {
            case FILMS -> filmEventRepository.findAll(pageable);
            case CONCERTS -> concertEventRepository.findAll(pageable);
